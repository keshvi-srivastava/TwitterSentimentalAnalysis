...
def main():
    ...
    sentiment_fit_romney = checker_pipeline.fit(x_train, y_train)

    #Test the validation set
    y_pred_val = sentiment_fit_romney.predict(x_validation)
    ...
    #Test the test set
    y_pred_test = sentiment_fit_romney.predict(x_test)
    print("Test data report\n")
    print(accuracy_score(y_test, y_pred_test))
    print(classification_report(y_test, y_pred_test, target_names=target_class))

    with open('clf_romney.pickle', 'wb') as f:
        pickle.dump(sentiment_fit_romney, f)
